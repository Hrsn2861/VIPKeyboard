...
public class GestureDetectorOri {
    public enum Direction {
        ...
        public static com.example.audiokeyboard.Utils.GestureDetector.Direction getDirectionByValue(int value) {
            for (com.example.audiokeyboard.Utils.GestureDetector.Direction dir : com.example.audiokeyboard.Utils.GestureDetector.Direction.values()) {
                if (dir.value == value) {
                    return dir;
                }
            }
    ...
    private com.example.audiokeyboard.Utils.GestureDetector.Direction firstDir[] = new com.example.audiokeyboard.Utils.GestureDetector.Direction[TRACK_POINTER_NUM];
    private com.example.audiokeyboard.Utils.GestureDetector.Direction secondDir[] = new com.example.audiokeyboard.Utils.GestureDetector.Direction[TRACK_POINTER_NUM];
...
//                movePos[actionId][1] = y;
                    if (hasDir && time - midTime < TIME_THRESHOLD) {
                        if (Math.abs(movePos[actionId][0] - midPos[actionId][0]) > second_threshold &&
                            ...
                            if (movePos[actionId][0] > midPos[actionId][0]) {
                                secondDir[actionId] = com.example.audiokeyboard.Utils.GestureDetector.Direction.RIGHT;
                            } else {
                                secondDir[actionId] = com.example.audiokeyboard.Utils.GestureDetector.Direction.LEFT;
                            }
                            ...
                            if (movePos[actionId][1] > midPos[actionId][1]) {
                                secondDir[actionId] = com.example.audiokeyboard.Utils.GestureDetector.Direction.DOWN;
                            } else {
                                secondDir[actionId] = com.example.audiokeyboard.Utils.GestureDetector.Direction.UP;
                            }
                        }
                        hasSecondDir = true;
                    ...
                    if (!hasDir && time - startTime < TIME_THRESHOLD) {
                        if (Math.abs(movePos[actionId][0] - startPos[actionId][0]) > DISTANCE_THRESHOLD
                            ...
                            if (movePos[actionId][0] > startPos[actionId][0]) {
                                firstDir[actionId] = com.example.audiokeyboard.Utils.GestureDetector.Direction.RIGHT;
                            } else {
                                firstDir[actionId] = com.example.audiokeyboard.Utils.GestureDetector.Direction.LEFT;
                            }
                            ...
                            if (movePos[actionId][1] > startPos[actionId][1]) {
                                firstDir[actionId] = com.example.audiokeyboard.Utils.GestureDetector.Direction.DOWN;
                            } else {
                                firstDir[actionId] = com.example.audiokeyboard.Utils.GestureDetector.Direction.UP;
                            }
                        }
                    }
                }
    ...
    public interface onGestureListener {
        public void onSwipe(com.example.audiokeyboard.Utils.GestureDetector.Direction direction);
        public void on2FingerSwipe(com.example.audiokeyboard.Utils.GestureDetector.Direction direction);
        public void onTap(MotionEvent event);
    }
    private com.example.audiokeyboard.Utils.GestureDetector.onGestureListener listener = null;

    public GestureDetectorOri(com.example.audiokeyboard.Utils.GestureDetector.onGestureListener gestureListener) {
        this.listener = gestureListener;
    }

    private void slideResponse(int fingerNum, com.example.audiokeyboard.Utils.GestureDetector.Direction[] direction1, com.example.audiokeyboard.Utils.GestureDetector.Direction[] direction2) {
    ...
    private com.example.audiokeyboard.Utils.GestureDetector.Direction joinDirection(com.example.audiokeyboard.Utils.GestureDetector.Direction d1, com.example.audiokeyboard.Utils.GestureDetector.Direction d2) {
        if (d2 == null) return d1;
        if (d1 == d2) return d1;
        return com.example.audiokeyboard.Utils.GestureDetector.Direction.getDirectionByValue((1+d1.value) * 4+d2.value);
    }

    private String debug(com.example.audiokeyboard.Utils.GestureDetector.Direction[] dir) {
        String ret = "<";
